...
<body class="min-h-screen text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="../index.php" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 transition">
                        <i class="fas fa-home"></i> Acasă
                    </a>
                    <a href="../despre.php" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 transition">
                        <i class="fas fa-info-circle"></i> Despre noi
                    </a>
                    <a href="../articole.php" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 transition">
                        <i class="fas fa-newspaper"></i> Articole
                    </a>
                    <a href="../galerie.php" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 transition">
                        <i class="fas fa-images"></i> Galerie
                    </a>
                    <a href="../contact.php" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-white/10 transition">
    ...
    <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="glass-card rounded-3xl p-12 mb-8 text-center shadow-xl">
    ...
    <!-- Footer -->
    <footer class="glass-card border-t border-white/20 mt-12 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                <p class="mb-4 md:mb-0 text-white/80">&copy; 2025 Reședința Budaș. Toate drepturile rezervate.</p>
                <div class="text-center md:text-right space-x-2 text-white/80">
    ...
    <!-- Back to Top -->
    <button onclick="window.scrollTo({top: 0, behavior: 'smooth'})" id="backToTop" class="fixed bottom-8 right-8 w-12 h-12 glass-card rounded-full hidden items-center justify-center hover:bg-white/20 hover:-translate-y-1 transition z-50">
